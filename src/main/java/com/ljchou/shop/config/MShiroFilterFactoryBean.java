package com.ljchou.shop.config;
...
public class MShiroFilterFactoryBean extends ShiroFilterFactoryBean{
    ...
    protected AbstractShiroFilter createInstance() throws Exception {
        ...
        if (null == securityManager) {
            throw new BeanInitializationException("getSecurityManager must be set");
        }

        if (! (securityManager instanceof WebSecurityManager)) {
            throw new BeanInitializationException("this securityManager does not implement the WebSecurityManager interface.");
        }
